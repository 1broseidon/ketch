...
using ketch, written as prose, not a list of commits. The section is published
...
**Moved the extraction benchmark to its own repository.** [ketch-bench](https://github.com/1broseidon/ketch-bench) pins the 500-page corpus as a release asset and gates both extraction modes against accepted baselines, so neither the corpus nor the reports weigh on this repository.
