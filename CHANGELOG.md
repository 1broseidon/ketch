...
- Extraction benchmark, in its own repository: [ketch-bench](https://github.com/1broseidon/ketch-bench) pins 500 pages from 70 websites across 28 content types with 3,573 source-backed checks, measures median/p95 timing and concurrent stress runs, and gates both extraction modes against accepted baselines. It builds a sibling ketch checkout, so neither the corpus nor the reports weigh on this repository.
