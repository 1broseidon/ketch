...
// extractModes lists the values extract_mode accepts, default first:
// complete keeps everything the page's structure does not condemn, clean
// also drops blocks by name and phrase. The extract package owns the
...
// step.
var extractModes = []string{"complete", "clean"}
