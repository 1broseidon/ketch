...
type SearchInput struct {
	...
	Backend    string   `json:"backend,omitempty" jsonschema:"search backend: brave, ddg, searxng, exa, firecrawl, keenable, tavily, parallel, serpbase, or youcom (default: the configured backend)"`
...
func (s *Server) registerSearchTool() {
	mcpsdk.AddTool(s.mcp, &mcpsdk.Tool{
		Name: "search",
		Description: "Search the web using Brave, DuckDuckGo, SearXNG, Exa, Firecrawl, Keenable, Tavily, Parallel, SerpBase, or You.com (default: the configured backend) and return results (title, url, description). " +
