...
10. **youcom — You.com web search.** Works with zero config via the keyless free profile; an optional `ketch config set youcom_api_key <key>` (get one at you.com/platform/api-keys) lifts the rate limit.
