...
10. **youcom — keyed You.com web search.** Needs a key: `ketch config set youcom_api_key <key>` (get one at you.com/platform/api-keys), then `ketch config set backend youcom`.
