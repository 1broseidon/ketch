...
| --- | --- | --- | --- |
| search | ddg, searxng (self-hosted), exa, firecrawl, keenable, parallel, youcom | brave, tavily, serpbase | `ketch config set brave_api_key <key>` / `tavily_api_key` / `serpbase_api_key` (optional `firecrawl_api_key` / `youcom_api_key` lift the hosted caps) |
