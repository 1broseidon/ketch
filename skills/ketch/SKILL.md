...
| **backend** | The provider behind a surface: brave/ddg/searxng/exa/firecrawl/keenable/tavily/parallel/serpbase/degoog/youcom (search), grepapp/sourcegraph/github (code), context7 (docs) |
